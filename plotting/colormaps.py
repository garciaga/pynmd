...
#
#
# Turbo Colormap added from 
#     https://gist.github.com/FedeMiorelli/640bbc66b2038a14802729e609abfe89
#     With license: https://ai.googleblog.com/2019/08/turbo-improved-rainbow-colormap-for.html
...
for (name, data) in (('magma', _magma_data),
                     ...
                     ('parula', _parula_data),
                     ('turbo',_turbo_data),
                     ('turbo_r',list(reversed(_turbo_data)))):
